...
const Information = () => {
    return (
        <div className="container mx-auto my-12 flex flex-col lg:flex-row justify-between gap-8 text-white">
            <div className='bg-[#811A64] flex gap-5 w-full lg:w-[364px] h-full lg:h-[202px] p-12 rounded-xl'>
            ...
            <div className='bg-[#0E6159] flex gap-5 w-full lg:w-[364px] h-full lg:h-[202px] p-12 rounded-xl'>
