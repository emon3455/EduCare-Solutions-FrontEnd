        ...
        <CContainer>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-7">
                <div className="border border-[#E6E6E6] rounded-xl">
                    <img className="w-full" src="https://i.ibb.co/KxDxppB/Rectangle-15-1.png" alt="" />
                    <div className="p-5">
                ...
                <div className="border border-[#E6E6E6] rounded-xl">
                    <img className="w-full" src="https://i.ibb.co/7QYST1W/Rectangle-15-2.png" alt="" />
                    <div className="p-5">
                        <h3 className="mt-3 font-bold text-xl">Web Development</h3>
                        <p className="text-[#6C6B6B]">Instructor: Jhankar Mahbub</p>
                        <img className="mt-2" src="https://i.ibb.co/NYdVqZt/Group-24.png" alt="" />
                ...
                <div className="border border-[#E6E6E6] rounded-xl">
                    <img className="w-full" src="https://i.ibb.co/QNQKdZh/Rectangle-15-3.png" alt="" />
                    <div className="p-5">
                        <h3 className="mt-3 font-bold text-xl">Web Development</h3>
                        <p className="text-[#6C6B6B]">Instructor: Jhankar Mahbub</p>
                        <img className="mt-2" src="https://i.ibb.co/NYdVqZt/Group-24.png" alt="" />
