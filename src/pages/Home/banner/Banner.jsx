            ...
            <div className="container mx-auto">
                <div className="flex flex-col-reverse lg:flex-row lg:justify-between items-center lg:gap-x-20">
                    <div className="w-full lg:w-1/2">
                        <h2 className="text-2xl md:text-4xl lg:text-6xl text-justify font-semibold ">Edu-Care Solution, Your Best Learning Partner. Our Service your solution</h2>
                        ...
                        <button className="btn-lg rounded-xl bg-secondary px-7 py-4 text-white font-bold">All Service</button>
                    </div>
                    <div className="w-full lg:w-1/2">
