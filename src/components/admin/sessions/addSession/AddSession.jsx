...
const AddSession = ({ setOpen, refetch, categorys, role }) => {
  ...
  const [
    addSession,
    {
      isLoading: addSessionIsLoading,
      isSuccess: addSessionIsSuccess,
      isError: addSessionIsError,
    },
  ...
  useEffect(() => {
    if (addSessionIsSuccess) {
      Swal.fire("Session Added Successfully!", "Success!", "success");
      refetch();
      setOpen(false);
    }
